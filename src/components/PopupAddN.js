...
const AddPopUp = () => {
    ...
    const click = () => {
        //const dataN = JSON.stringify({"id": data.length+1, "Classname" : "notebook "+nameN+"-notebook", "Title" : nameN, "LastTimeUse" : "Editado: --", "color": color})
        data.push({"id": data.length+1, "Classname" : "notebook "+nameN+"-notebook", "Title" : nameN, "LastTimeUse" : "Editado: --", "Color": color})
